        ...
        <section className="relative h-[90vh] overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              fill
              className="object-cover transform-gpu animate-scale-slow"
              priority
            />
          </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent pb-16 pt-40 fade-in">
              <div className="container mx-auto px-4">
                <div className="max-w-3xl">
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white slide-up stagger-3">
                    <span className="inline-block">Global Logistics Solutions</span>
                    <span className="inline-block stagger-5">for Your Business</span>
                  </h1>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={index}
                  className={`bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border transition-all duration-500 hover:shadow-md hover:border-primary/50 hover:translate-y-[-5px] slide-up`}
